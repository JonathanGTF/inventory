...
INSERT INTO `users` (`id`, `name`, `email`, `password`, `branch_id`, `role_id`, `remember_token`, `created_at`, `updated_at`) VALUES
	(12, 'Jonathan Valentin Gomez', 'yonathangomez439@gmail.com', '$2a$08$fw66lUZLWPM1Jy.YXxlfqeVCfVTvfiHZjj3ErRh.bY8fxpRoQsfae', 1, 2, '$2a$08$f6uDQ3BlIDUJj6V/HaCUneyi.SuHvovv.RQawGsPQZKCB6XO/gSiW', '2020-07-31 17:27:25', '2023-04-17 05:20:18');
